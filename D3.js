...
//   } else if (starWarsCharacters[i].eye_color === "yellow") {
//     eyeColor.yellow.push(starWarsCharacters[i]);
//   } else if (starWarsCharacters[i].eye_color === "brown") {
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "n/a")
    console.log((starWarsCharacters[i].gender = "robot"));
}
console.log(starWarsCharacters);

/* --EXTRA-- ESERCIZIO 9
  Utilizzando gli elementi presenti nell'array "femaleCharacters" rimuovi dall'array "characters" le stringhe corrispondenti a personaggi 
  con lo stesso nome.
  Una volta fatto crea un console.log per controllare la proprietà length di "characters" prima e dopo l'operazione.
*/

for (let i = 0; i < starWarsCharacters.length; i++)
  if (starWarsCharacters[i].name === femaleCharacters.name) {
